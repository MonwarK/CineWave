...
export default function ProfileReviewListItem({review} : Props) {
  ...
  return (
    <div className="bg-zinc-800/50 rounded-md p-5 border border-gray-600 backdrop:blur-2xl flex items-center">
      ...
      <div className='space-y-1 flex-1'>
          ...
          <div className='flex gap-2 items-center'>
            ...
            •
            <p className='text-sm'>{review.is_movie ? "Movie": "TV Show"}</p>
          </div>
